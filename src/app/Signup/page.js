            ...
            {error && (
              <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-md text-sm">
                ...
                <Link
                  ...
                  className="cursor-pointer flex gap-3 items-center justify-center w-full hover:scale-102 transition-all duration-300  active:scale-98   bg-black   text-white px-5 py-3 rounded-xl font-serif text-xl"
                >
